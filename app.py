...
class MainWindow(ttk.Window):
    ...
    def __init__(self):
        ...
        self.revenue_btn.grid(row=0, column=0, padx=10, pady=5, ipady=10, sticky="W")
        self.vat_btn.grid(row=1, column=0, padx=10, pady=5, ipady=10, sticky="W")
        self.social_security_btn.grid(
            row=2, column=0, padx=10, pady=5, ipady=10, sticky="W"
        )

        # create info frame items
    ...
    def fetch_total_paid_vat(self):
        ...
        self.total_quarter_vat = self.curr.fetchone()[0]  # Fetch the first value
    ...
    def calc_gross_revenue(self):
        ...
        self.gross_revenue_lbl.config(
            text=f"{'Bruto Inkomsten:':<16} {self.gross_revenue:>20,.2f}€"
        )
